      ...
      case 3:
        {
          ...
          row = 2;
          coordinates.addAll(
              [Coordinates(0, 1), Coordinates(1, 2), Coordinates(1, 0)]);
        }
        break;
...
class ReportGraph {
  ...
  String deleteCharacters(String str) {
    ...
    Function isAccentedLetter =
        (int x) => [233, 232, 242, 224, 249].contains(x);
    Function isSymbol = (int x) => x == 32 || x == 39;
    Function toReplace = (int x) =>
        !(isNumber(x) || isLetter(x) || isAccentedLetter(x) || isSymbol(x));
  ...
  bool contains(String str) {
    return _nodes.firstWhere((n) => n.getText() == str, orElse: () => null) !=
        null;
  }
