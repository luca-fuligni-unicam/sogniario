...
class _InfoPrivacyState extends State<InfoPrivacy> {
  ...
  Widget build(BuildContext context) {
    return InfoPage(
      title: 'App Privacy',
      content: "Il trattamento delle risposte e dei dati da lei forniti è finalizzato alla realizzazione di una ricerca scientifica relativa all’applicazione delle neuroscienze nella caratterizzazione dei processi decisionali.\n\n" +
